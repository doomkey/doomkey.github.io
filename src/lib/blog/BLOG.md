...
This is the reference doc for anyone writing or planning blog content for Doomkey. It covers who we're writing for, what we write about, how it should sound, how to structure an article, and how to keep generating new topics without starting from zero every time.

---

## 1. Who We're Writing For

Our reader is a **business owner, not a developer**. They run a real business - a shop, a brand, a small e-commerce operation - but their digital setup is incomplete or held together with workarounds. Common profile:

- Has a Facebook Page (often with a real following) but no website, or a website but no branded email
- Uses a personal Gmail address for business (e.g. `mybusiness123@gmail.com`)
- Sells through marketplaces (Daraz, Instagram, WhatsApp) instead of, or in addition to, their own site
- Is not technical and doesn't want to become technical - they want someone to just handle it
- Cares about looking credible/trustworthy to customers, and about being findable on Google
...
## 3. Content Categories (How to Bucket a New Idea)

When brainstorming, sort ideas into one of these categories. This is also the fastest way to spot a gap in our calendar - if one category is empty, write there next.

1. **Pain-point / awareness** - makes the reader recognize their own setup is a problem
   _e.g. "You Have 50K Followers and No Website - Here's Why That's a Problem"_
2. **Checklist / how-to for non-technical owners** - plain-language, step-based
   _e.g. "SEO in Plain Language for Shop Owners"_
3. **Milestone-triggered** - tied to a moment in the business lifecycle (just registered, just left a marketplace, just hit a follower milestone)
   _e.g. "Your Business Registration Is Done - Now What?"_
4. **Comparison** - X vs. Y framing, good for capturing people actively deciding
   _e.g. "Gmail vs Business Email: What Customers Actually Notice"_
5. **Trust / credibility signals** - shareable, softer sell, works well for social distribution
   _e.g. "What Makes a Facebook Page Business Look Legitimate"_
6. **Vertical-specific** - same core pain point, rewritten for one industry (see Section 6)
   _e.g. "Why Furniture Brands Need a Professional Website and Business Email"_
7. **Bottom-of-funnel / commercial** - pricing, "how much does X cost," direct comparison to doing it yourself
...
- Use real examples (`hello@yourbusiness.com`, `nicefurnitures@gmail.com`) rather than abstractions
...
Use this as the default skeleton. Not every section is mandatory, but this order works for most of our content categories.

1. **Headline** - name the specific pain point or question, not a vague topic. ("Why Your Facebook Shop Isn't Enough Anymore," not "E-commerce Trends 2026")
2. **Opening (2–4 sentences)** - state the problem plainly, make the reader recognize themselves
...
## 6. The Vertical Template (Reuse This for New Industries)

Vertical posts are our fastest way to scale content - same structure, same core argument, swapped industry details. Use this fill-in-the-blank pattern:

> **"Why [Industry] Brands/Businesses Need a Professional Website and Business Email"**
>
> 1. Open with something specific to that industry's current online behavior (e.g., furniture brands rely heavily on visual catalog posts; restaurants rely on delivery apps and WhatsApp orders)
> 2. Name the industry-specific trust or verification issue (e.g., furniture = high-ticket purchases need more buyer trust; restaurants = food delivery platforms require business verification)
> 3. Tie it back to the same three pillars: website, SEO, email
> 4. Close with the same CTA structure

**Industries worth templating next** (in priority order based on who we cold-email most): furniture, fashion/clothing, restaurants, beauty/salons, electronics resellers, home services (contractors, cleaners), education/tutoring centers.

When you finish a vertical post, add it to the tracking table in Section 9 so we don't duplicate industries.

---

## 7. SEO Guidelines (Keep It Simple)

We're writing for humans first, but every post should be structured to actually rank.

- **One primary keyword per article**, used in: the title, the first paragraph, one H2, and the meta description
...
## 8. How to Generate New Article Ideas (Ideation Framework)

When the calendar is running low, work through these prompts in order - they almost always produce more ideas than you need:

1. **Take a Doomkey service and ask "what question does someone Google right before they need this?"**
   _e.g. business email → "why did my business email get flagged as spam"_
2. **Take a content category (Section 3) that's underrepresented in the last month's calendar and force an idea into it.**
3. **Take an industry not yet covered (Section 6) and run it through the vertical template.**
4. **Look at real objections/questions from cold email replies or sales calls** - if a prospect asked it, other prospects are wondering it too. Turn objections into article titles directly.
